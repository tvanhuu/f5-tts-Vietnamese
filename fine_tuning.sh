...
BATCH_SIZE=500  # Tăng lên 500 frames (phù hợp với dataset nhỏ)
NUM_WOKERS=8    # Theo warning khuyến nghị
WARMUP_UPDATES=20   # Giảm warmup vì model đã tốt rồi
SAVE_UPDATES=100    # Lưu checkpoint mỗi 100 updates
LAST_UPDATES=100    # Giữ 100 checkpoint gần nhất
PRETRAIN_CKPT="F5-TTS-Vietnamese/model_last.pt"  # Sử dụng model có sẵn
